const monitorZones = [
    {
        ...
        tileX: 1774, tileY: 795, // /s0/pixel 훼손자 조회용 (tileUrl과 동일한 좌표, 파싱 없이 재사용)
    ...
    },
    {
        ...
        tileX: 1746, tileY: 793, // /s0/pixel 훼손자 조회용 (tileUrl과 동일한 좌표, 파싱 없이 재사용)
